...
\caption{CASM behaviour on held-out Beat This activations from SMC. Clear local periodicity recovers weak activation-supported beats (left), whereas ambiguity among competing periods weakens the duration preference, allowing the decoded path to match Direct in this example (right). Reference IBI is shown only for interpretation.}
