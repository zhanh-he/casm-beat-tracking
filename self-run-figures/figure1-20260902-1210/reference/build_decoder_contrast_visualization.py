...
<div id="decoder-contrast-real-v2" class="decoder-contrast-real">
  <style>
    ...
    #decoder-contrast-real-v2 .metric-table th:nth-child(2),
    #decoder-contrast-real-v2 .metric-table th:nth-child(3),
    #decoder-contrast-real-v2 .metric-table th:nth-child(4) { width: 13%; }
    #decoder-contrast-real-v2 .metric-table th:nth-child(5) { width: 15%; text-align: right; }
    #decoder-contrast-real-v2 .metric-table th:last-child,
    #decoder-contrast-real-v2 .metric-table td:last-child { width: 18%; text-align: center; }
    #decoder-contrast-real-v2 .metric-table tbody tr:hover { background: #f7faf9; }
    #decoder-contrast-real-v2 .metric-table .reference-row { border-bottom: 2px solid var(--border); }
    ...
    #decoder-contrast-real-v2 .table-play::before {
      content: ""; display: inline-block; width: 0; height: 0;
      border-top: 5px solid transparent; border-bottom: 5px solid transparent;
      border-left: 7px solid currentColor; margin-left: 2px;
    }
